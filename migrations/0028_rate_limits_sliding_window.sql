-- Migration: Add rate_limits table for globally-consistent sliding-window rate limiting
--
...
-- to bypass rate limits. This table provides a globally-consistent counter
