...
// .wrangler/tmp/bundle-vuh3If/checked-fetch.js
...
// .wrangler/tmp/pages-05dkT6/functionsWorker-0.9748527792767414.mjs
...
__name2(logAuthEvent, "logAuthEvent");
...
__name(logAuthEvent2, "logAuthEvent2");
__name2(logAuthEvent2, "logAuthEvent");
async function onRequestPost2(context) {
  ...
  try {
    ...
    if (!masterPassword) {
      await logAuthEvent2(DB, ipAddress, "password_reset", false, {
    ...
    await logAuthEvent2(DB, ipAddress, "password_reset", true);
    return new Response(
      JSON.stringify({
        success: true,
...
__name2(checkConflicts, "checkConflicts");
...
__name(checkConflicts2, "checkConflicts2");
__name2(checkConflicts2, "checkConflicts");
...
__name2(generateICal, "generateICal");
function escapeIcal(text) {
  if (!text) return "";
  return text.replace(/\\/g, "\\\\").replace(/;/g, "\\;").replace(/,/g, "\\,").replace(/\n/g, "\\n");
}
__name(escapeIcal, "escapeIcal");
__name2(escapeIcal, "escapeIcal");
...
__name(getClientIP3, "getClientIP3");
__name2(getClientIP3, "getClientIP");
async function checkRateLimit2(DB, ipAddress) {
...
__name2(recordFailedAttempt, "recordFailedAttempt");
...
__name2(resetRateLimit, "resetRateLimit");
async function logAuthEvent3(DB, ipAddress, action, success, details = null) {
...
__name(logAuthEvent3, "logAuthEvent3");
__name2(logAuthEvent3, "logAuthEvent");
async function onRequest(context) {
  ...
  try {
    const rateLimitCheck = await checkRateLimit2(DB, ipAddress);
    if (!rateLimitCheck.allowed) {
      await logAuthEvent3(DB, ipAddress, "api_access_blocked", false, {
        reason: "rate_limited",
        minutesRemaining: rateLimitCheck.minutesRemaining
      });
      return new Response(
    ...
    if (!adminPassword) {
      await logAuthEvent3(DB, ipAddress, "api_access_denied", false, {
    ...
    await logAuthEvent3(DB, ipAddress, "api_access_granted", true);
...
// .wrangler/tmp/bundle-vuh3If/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-vuh3If/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9748527792767414.js.map
