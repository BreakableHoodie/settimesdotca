          ...
          <div className="bg-band-purple rounded-xl border-2 border-band-orange/30 overflow-hidden mb-6 shadow-xl">
            ...
            {(profile.description || profile.social) && (
              <div className="p-6 bg-band-purple/50 border-t border-white/10">
                {profile.description && (
                  <div
                    className="prose prose-invert prose-sm mb-4 text-white/90 prose-p:my-2 prose-p:leading-relaxed prose-a:text-accent-500 hover:prose-a:underline [&_p]:break-words [&_p]:[word-break:normal]"
                    style={{ maxWidth: '100%' }}
