                          ...
                          <td className="px-4 py-3">
                            <div className="flex justify-end gap-2">
                              <button
                                ...
                                className="px-4 py-2 min-h-[44px] bg-amber-600 hover:bg-amber-700 text-white rounded text-sm font-medium transition-colors"
                              >
                                Edit
                              </button>
                  ...
                  <div key={venue.id} className="p-4 space-y-3">
                    ...
                    {!readOnly && (
                      <div className="flex gap-2 pt-2">
                        <button
                          onClick={() => startEdit(venue)}
                          className="flex-1 px-3 py-2 min-h-[44px] bg-amber-600 hover:bg-amber-700 text-white rounded text-sm font-medium transition-colors"
                        >
                          Edit
                        </button>
                        <button
