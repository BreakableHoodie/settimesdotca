...
1. **Add more details to band profiles:**
   ...
   - Click **"Edit"** on a band
   - Add **description**, **website**, and **social media links**
   - Click **"Save"**

2. **Add venue details:**
   - Go to **📍 Venues** tab
   - Click **"Edit"** on a venue
   - Add **website**, **Instagram**, and **Facebook**
   - Click **"Save"**

3. **Share your event:**
   - Copy the URL: `settimes.ca`
   - Share on social media
   - Include band profile links for better engagement

### Learn More

- **Full User Guide:** [USER_GUIDE.md](./USER_GUIDE.md) - Comprehensive documentation
...
1. **Bottom Navigation:**
   - Tap **📅 Events**, **📍 Venues**, or **🎸 Performers** at the bottom

2. **Touch-Friendly:**
   - All buttons are large (44px minimum)
   - Easy to tap without mistakes

3. **Swipe Gestures:**
   - Swipe left on a band to reveal delete button
   - Swipe right to hide

4. **Form Tips:**
   - Use your phone's time picker for times
   - Keyboard auto-adjusts (email keyboard, number pad, etc.)
...
**You're Ready!** You now know the basics of SetTimes. Explore the full [User Guide](./USER_GUIDE.md) to learn advanced features.
