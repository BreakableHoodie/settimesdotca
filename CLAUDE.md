...
`view_count_legacy` preserves each link's pre-#705 count. Nothing reads it; it exists so the cutover is reversible and the old figure stays queryable.
