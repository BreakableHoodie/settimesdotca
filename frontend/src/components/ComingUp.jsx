        ...
        >
          <div className="container mx-auto max-w-(--breakpoint-2xl)" title={message}>
            <div className="flex items-center gap-2 sm:hidden">
              <span className="shrink-0 text-[11px] font-bold uppercase tracking-[0.18em] text-bg-navy/70">Up Next</span>
              ...
              <span className="min-w-0 truncate text-sm font-semibold text-bg-navy">
                {nextBand.name}
                {nextBand.venue && <span className="text-bg-navy/75"> · {nextBand.venue}</span>}
              </span>
            </div>
