        ...
        <div className='bg-band-purple p-6 rounded-lg border border-band-orange/20'>
          ...
          <form onSubmit={editingId ? handleUpdate : handleAdd}>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4'>
              <div>
                <label htmlFor="venue-name" className='block text-white mb-2 text-sm'>Venue Name *</label>
                <input
                  type='text'
                  name='name'
                  value={formData.name}
              ...
              <div>
                <label htmlFor="venue-address" className='block text-white mb-2 text-sm'>Address</label>
                <input
                  type='text'
                  name='address'
